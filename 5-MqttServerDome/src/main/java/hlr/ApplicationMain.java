...
public class ApplicationMain {
    ...
    @Bean
    public ThreadsPoolFactory threadsPoolFactory(JmsMqttMqReceiver jmsMqttMqReceiver,JmsMqttMqSender jmsMqttMqSender) {
        ThreadsPoolFactory threadsPoolFactory = new ThreadsPoolFactory();
        threadsPoolFactory.addPool(jmsMqttMqReceiver);
        threadsPoolFactory.addPool(jmsMqttMqSender);
